    ...
    <div class="row justify-content-center text-center mt-5 pt-5">
        <div class="col-md-8">
            ...
            if($_GET['ert']) {
                ...
                <span class="text-dark font-weight-bold" style="font-family: sans-serif;font-size: 32px"><?php echo $flname?>'s Submission Form</span>
                <p class="text-muted">you can only read the submission form</p>
                <p class="text-dark font-weight-bold">This is submitted on <?php echo $rdate ?></p>
                <hr>
                <div id="accordion">
                    <div class="card">
                            ...
                            <div class="card-body">
                                <div class="md-form-group mt-3">
                                    ...
                                    if($idtype=="Passport (Photo Page)")
                                    {
                                        ...
                                        ?>
                                        <p>
                                        <a href="../public/uploads/<?php echo $filedownload ?>" class="btn btn-primary" download>Download document</a>
                                        </p>
                                        <?php
                                    }
                                    if($idtype=="National ID (Front & Back)")
                                    {
                                        ...
                                        ?>
                                        <p>
                                        <a href="../public/uploads/<?php echo $filedownload11 ?>" class="btn btn-primary" download>Download document</a>
                                        </p>
                                        ...
                                        ?>
                                        <p>
                                        <a href="../public/uploads/<?php echo $filedownload21 ?>" class="btn btn-primary" download>Download document</a>
                                        </p>
                                        <?php
                                    ...
                                    if($doctype=="Visa")
                                    {
                                        ...
                                        ?>
                                        <p>
                                        <a href="../public/uploads/<?php echo $filedownload41 ?>" class="btn btn-primary" download>Download document</a>
                                        </p>
                                        <?php
                                    }
                                    if($doctype=="Residence Permit")
                                    {
                                        ...
                                        ?>
                                        <p>
                                        <a href="../public/uploads/<?php echo $filedownload51 ?>" class="bnt btn-primary" download>Download document</a>
                                        </p>
                                        ...
                                        ?>
                                        <p>
                                        <a href="../public/uploads/<?php echo $filedownload61 ?>" class="btn btn-primary" download>Download document</a>
                                        </p>
                                        <?php
                                    ...
                                    if($doctype=="Home Office Letter")
                                    {
                                        ...
                                        ?>
                                        <p>
                                        <a href="../public/uploads/<?php echo $filedownload71 ?>" class="btn btn-primary" download>Download document</a>
                                        </p>
                                        <?php
                                    }
                                    ?>
                    ...
                    <div class="card">
                        ...
                        <div id="collapse17" class="collapse" aria-labelledby="heading17" data-parent="#accordion">
                            ...
                            ?>
                            <p>
                            <a href="../public/uploads/<?php echo $filedownload81 ?>" class="btn btn-primary" download>Download document</a>
                            </p>
                            ...
                            ?>
                            <p>
                            <a href="../public/uploads/<?php echo $filedownload91 ?>" class="btn btn-primary" download>Download document</a>
                            </p>
                            <div class="md-form">
                    ...
                    <div class="card">
                        ...
                        <div id="collapse18" class="collapse" aria-labelledby="heading18" data-parent="#accordion">
                            ...
                            ?>
                            <p>
                            <a href="../public/uploads/<?php echo $filedownload101 ?>" class="btn btn-primary" download>Download document</a>
                            </p>
                        </div>
                    </div>
                </div>
                <hr>
                <form method="POST" action="assets/comment.php">
                     <div class="form-group shadow-textarea">
                          <i class="fas fa-pencil-alt prefix"></i>
                          <label for="exampleFormControlTextarea6">Comment Here...</label>
                          <textarea class="form-control z-depth-1" id="exampleFormControlTextarea6" name="comment" rows="3" placeholder="Write comment here..."></textarea>
                     </div>
                     <input type="submit" name="submit" value="Comment" class="btn btn-elegant">
                </form>
            ...
            {
                echo "<script>alert('Data cannot be handled (URL)')</script>";
