...
<div class="container-fluid" id="body-secondary">
    ...
    <div class="row justify-content-center py-5">
        <div class="col-md-3 h-100 text-center  text-white" id="formstylecon">
            ...
            <span>
                <a href="public/login.php" class="btn btn-success rounded-pill ui-spinner-down" id="btn-login">LOGIN</a>
            </span>
        </div>
            ...
            <form id="regForm" action="registration.php" class="form mb-5" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="tab" id="tab1">
                    ...
                    <div class="md-form-group mt-3">
                        <label for="selectDepot" class="font-weight-bold">Depot Selection <strong class="text-danger">*</strong></label>
                        <select name="selectdeopt" onchange="checkSelectDepot()" class="browser-default custom-select custom-select- mb-3 required" id="selectDepot" required>
                            <option value="none" selected disabled>Please select a Depot</option>
                    ...
                    <script>
                        function checkidtype()
                        {
                            ...
                            if (idtype == "Passport (Photo Page)")
                            {
                                ...
                                document.getElementById('notify-sec-5').innerHTML = "<div class='custom-file'><input type='file' class='custom-file-input' name='ppupload' id='uploadpassport' onchange='readfilename1()' accept='image/*' required><label class='custom-file-label' for='uploadpassport'>Passport Upload (Photo Page)<strong class='text-danger'>* (images-.png,.jpg,jpeg,bmp)</strong></span></label></div>";
                            ...
                            else if(idtype == "National ID (Front & Back)")
                            {
                                document.getElementById('read-file-path-1').innerHTML="";
                                document.getElementById('read-file-path-2').innerHTML="";
                                document.getElementById('notify-sec-5').innerHTML ="<div class='custom-file'><input type='file' class='custom-file-input' name='nidfrontupload' id='uploadnidfront' onchange='readfilename2()' accept='.image/*' required><label class='custom-file-label' for='uploadnidfront'>National ID (Front)<strong class='text-danger'>* (images-.png,.jpg,jpeg,bmp)</strong></span></label></div>";
                                document.getElementById('notify-sec-5-1').innerHTML ="<div class='custom-file'><input type='file' class='custom-file-input' name='nidbackupload' id='uploadnidback' onchange='readfilename3()' accept='.image/*' required><label class='custom-file-label' for='uploadnidback'>National ID (Back)<strong class='text-danger'>* (images-.png,.jpg,jpeg,bmp)</strong></span></label></div>";
                            }
                            else if(idtype == "Birth Certificate (UK Only)")
                            {
                                ...
                                document.getElementById('read-file-path-2').innerHTML="";
                                document.getElementById('notify-sec-5-1').innerHTML ="";
                                document.getElementById('notify-sec-5').innerHTML ="<div class='custom-file'><input type='file' class='custom-file-input' name='bcupload' id='uploadbc' onchange='readfilename4()' accept='image/*' required><label class='custom-file-label' for='uploadbc'>BC Upload (UK Only)<strong class='text-danger'>* (images-.png,.jpg,jpeg,bmp)</strong></span></label></div>";
                            }
                            else
                            {
                        ...
                        {
                            var allowedextensions = /(\.jpg|\.jpeg|\.png|\.bmp|\.gif)$/i;
                            const fi = document.getElementById('nidbackupload');
                            maxfilesize = 10 * 1024 * 1024;
                            var x = $('#nidbackupload').val();
                            filesize = fi.files[0].size;
                            if(x!="") {
                                if(filesize > maxfilesize)
                                {
                                    document.getElementById('read-file-path-2').innerHTML = "<p class='text-danger'>Try again!Maximum File Size is 10MB</p>";
                                    document.getElementById('nidbackupload').value="";
                                }
                                else if(!allowedextensions.exec(x))
                                {
                    ...
                    <script>
                        ...
                        function checkdoctype()
                        {
                            ...
                            if (idtype == "Visa")
                            {
                                ...
                                document.getElementById('notify-sec-6').innerHTML = "<div class='custom-file'><input type='file' class='custom-file-input' name='visaupload' id='uploadvisa' onchange='readfilename5()' accept='.docx,.doc,.pdf,image/*' required><label class='custom-file-label' for='uploadvisa'>VISA Upload<strong class='text-danger'>* (images, .pdf, .doc)</strong></span></label></div>";
                            }
                            else if(idtype == "Residence Permit")
                            {
                                ...
                                document.getElementById('read-file-path-3').innerHTML="";
                                document.getElementById('read-file-path-4').innerHTML="";
                                document.getElementById('notify-sec-6').innerHTML = "<div class='custom-file'><input type='file' class='custom-file-input' name='rpfrontupload' id='uploadresidencefront' onchange='readfilename6()' accept='.docx,.doc,.pdf,image/*' required><label class='custom-file-label' for='uploadresidencefront'>Permit Front Upload<strong class='text-danger'>* (images, .pdf, .doc)</strong></span></label></div>";
                                document.getElementById('notify-sec-6-1').innerHTML = "<div class='custom-file'><input type='file' class='custom-file-input' name='rpbackupload' id='uploadresidenceback' onchange='readfilename7()' accept='.docx,.doc,.pdf,image/*' required><label class='custom-file-label' for='uploadresidenceback'>Permit Back Upload<strong class='text-danger'>* (images, .pdf, .doc)</strong></span></label></div>";
                            }
                            else if(idtype == "Home Office Letter")
                            {
                                ...
                                document.getElementById('read-file-path-4').innerHTML="";
                                document.getElementById('notify-sec-6-1').innerHTML="";
                                document.getElementById('notify-sec-6').innerHTML = "<div class='custom-file'><input type='file' class='custom-file-input' name='holupload' id='uploadhfltr' onchange='readfilename8()' accept='.docx,.doc,.pdf,image/*' required><label class='custom-file-label' for='uploadhfltr'>HO Letter Upload<strong class='text-danger'>* (images, .pdf, .doc)</strong></span></label></div>";
                            }
                            else
                            {
                ...
                <div class="tab">
                    ...
                    <div class="form-group">
                        ...
                        <select onchange="checkstep17()" name="proofdoctype" class="browser-default custom-select custom-select-mb-3 required" id="proofdoctype" name="proofdoctype" required>
                            ...
                            <option value="bankletter">Bank Letter</option>
                            <option value="councilletter">Council Issued Letter</option>
                            <option value="hmrcletter">HMRC Letter</option>
                        </select>
                    </div>
                    <div class="form-group">
