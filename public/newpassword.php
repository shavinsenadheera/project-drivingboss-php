...
<div class="container-fluid" id="body-secondary" style="background: linear-gradient(90deg, rgba(0,1,34,1) 0%, rgba(170,170,170,1) 100%);">
    ...
    <div class="row justify-content-center py-5">
        <div class="col-md-3 h-100 text-center  text-white" id="formstylecon">
            <span class="font-weight-bold" style="font-size: 24px">ENTER THE NEW PASSWORD</span>
            <p style="color:#a2a2a2;font-size: 24px">refer you'r email</p>
            <hr>
        ...
        <div class="col-md-7 h-100" >
            <div class="d-flex justify-content-center text-center h-100">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="middlewaremain.php" method="POST">
                            ...
                            <div class="form-group">
                                <input type="submit" value="Confirm" name="submit" class="btn btn-warning float-right">
                            </div>
                        </form>
                    </div>
                </div>
...
{
    echo "<script>alert('Having some issue... Try again')</script>";
