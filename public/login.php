...
<div class="container-fluid" id="body-secondary" style="background: linear-gradient(90deg, rgba(0,1,34,1) 0%, rgba(170,170,170,1) 100%);">
    ...
    <div class="row justify-content-center py-5">
        <div class="col-md-3 h-100 text-center  text-white" id="formstylecon">
            <span class="font-weight-bold" style="font-size: 24px">LOGIN</span>
            <p style="color:#a2a2a2;font-size: 24px">Welcome to the Driving Boss</p>
            <hr>
            <div class="text-center">
                <p>If you do not have an account. Please click following button to register.</p>
                <p class="text-orange">Register with following button.</p>
                <span>
                          ...
                          <form action="loginverify.php" method="POST">
                               <div class="input-group form-group">
                                ...
                                <div class="form-group">
                                     <input type="submit" value="Login" name="submit" class="btn btn-success float-right">
                                </div>
                          </form>
                      </div>
